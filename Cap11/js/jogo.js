...
const trocarStatus = (num) => {
    if (num > 0) imgStatus.src = `img/face${num}.jpg`;
};
...
frm.addEventListener("submit", e => {
    ...
    if (palavraSorteada.includes(letra)) {
        ...
        const chances = Number(respChances.innerText) - 1; // diminui no de chances
        respChances.innerText = chances; // exibe novo no de chances
